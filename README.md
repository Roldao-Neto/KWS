...
Este projeto implementa um sistema de Keyword Spotting (KWS) otimizado para a Raspberry Pi Zero 2W. O modelo utiliza MFCCs (Mel-Frequency Cepstral Coefficients) para classificação de áudio, treinado com o Google Speech Dataset.
